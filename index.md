...
```
⋊> ~/G/m/app on master ⨯ meteor npm run start
...
The BaseCollection class wraps the Mongo.collection. It defines several methods.
...
```
⋊> ~/G/m/app on master ⨯ meteor npm run lint
